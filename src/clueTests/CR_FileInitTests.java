...
public class CR_FileInitTests {
	...
	public static void setUp() {
		ClueGame game = new ClueGame("clueBoard/ClueLayout.csv", "clueBoard/ClueLegend.txt");
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		...
		ClueGame game = new ClueGame("clueBoard/ClueLayoutBadColumns.csv", "clueBoard/ClueLegend.txt");
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		...
		ClueGame game = new ClueGame("clueBoard/ClueLayoutBadRoom.csv", "clueBoard/ClueLegend.txt");
		game.loadRoomConfig();
		game.getBoard().loadBoardConfig();
	}
	// Test that an exception is thrown for a bad config file
	...
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException {
		// overloaded Board ctor takes config file name
		ClueGame game = new ClueGame("clueBoard/ClueLayout.csv", "clueBoard/ClueLegendBadFormat.txt");
		game.loadRoomConfig();
		game.getBoard().loadBoardConfig();
	}
}