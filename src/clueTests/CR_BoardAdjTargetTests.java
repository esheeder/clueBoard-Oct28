...
public class CR_BoardAdjTargetTests {
	...
	public void testAdjacencyRoomExit()
	{
		...
		Assert.assertEquals(1, testList.size());
		Assert.assertTrue(testList.contains(board.getCellAt(10, 16)));
		//TEST DOORWAY DOWN
	...
	public void testAdjacencyDoorways()
	{
		...
		Assert.assertTrue(testList.contains(board.getCellAt(4, 3)));
		...
		Assert.assertTrue(testList.contains(board.getCellAt(15, 18)));
		Assert.assertTrue(testList.contains(board.getCellAt(14, 17)));
	...
	public void testAdjacencyWalkways()
	{
		...
		Assert.assertTrue(testList.contains(board.getCellAt(21, 16)));
		Assert.assertTrue(testList.contains(board.getCellAt(20, 15)));
		Assert.assertEquals(2, testList.size());
		
		// Test on right edge of board, next to 1 room piece
		testList = board.getAdjList(14, 22);
		Assert.assertTrue(testList.contains(board.getCellAt(14, 21)));
		Assert.assertTrue(testList.contains(board.getCellAt(13, 22)));
		Assert.assertEquals(2, testList.size());
